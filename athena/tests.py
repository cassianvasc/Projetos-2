...
class TesteE2E(LiveServerTestCase):
    ...
    def test_noticias_por_tag_filtra_corretamente(self):
        ...
        self.noticia_a = Noticia.objects.create(jornalista=jornalista,titulo='Título A', conteudo='Conteúdo A')
        self.noticia_b = Noticia.objects.create(jornalista=jornalista,titulo='Título B', conteudo='Conteúdo B')
        self.noticia_c = Noticia.objects.create(jornalista=jornalista,titulo='Título C', conteudo='Conteúdo C')
